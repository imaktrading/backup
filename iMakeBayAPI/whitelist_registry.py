...
WHITELISTS = {
    ...
    "gshock": {
        ...
        "Features": {
            ...
            "normalize": {
                ...
                "Carbon Core Guard": "",  # eBay非フィルタ値、削除
                "Activity Tracker": "",
                "Compass": "",
                "Barometer": "",
                "Tide Graph": "",
    ...
    "montbell": {
        ...
        "Outer Shell Material": {
            "values": ["Cotton", "Cotton Blend", "Nylon", "Polyamide", "Polyester", "Tweed", "Viscose", "Wool"],
            "strict": True,
            "normalize": {"Nylon Ripstop": "Nylon", "Polyester Blend": "Polyester"},
        },
        "Lining Material": {
            "values": ["Acetate", "Cotton", "Nylon", "Polyamide", "Polyester", "Wool"],
            "strict": True,
        },
        "Insulation Material": {
            "values": ["Down", "Polyester", "Synthetic", "Wool"],
            "strict": True,
            "normalize": {"Goose Down": "Down", "Duck Down": "Down", "Synthetic Down": "Synthetic", "PrimaLoft": "Synthetic"},
        },
        "Fabric Type": {
            "values": ["Canvas", "Denim", "Flannel", "Fleece", "Knit", "Microfiber", "Softshell", "Tweed"],
            "strict": True,
            "normalize": {"Soft Shell": "Softshell", "Soft-Shell": "Softshell"},
        },
        "Closure": {
            ...
            "normalize": {
                ...
                "1/2 Zip": "Zip",
                "Zipper": "Zip",
                "Pullover": "",  # Jacket Closureには無効値なので削除
                "Velcro": "Hook & Loop",
            },
        },
        "Performance/Activity": {
            ...
            "multi": True,
            "normalize": {
                "Outdoor": "Hiking",  # "Outdoor" はeBay非フィルタ値、Hikingに正規化
                "Camping": "Hiking",
                "Trail": "Hiking",
                "Trekking": "Hiking",
                "Bike": "Cycling",
        ...
        "Pattern": {
            "values": ["Camouflage", "Geometric", "Solid"],
            "strict": True,
            "normalize": {
        ...
        "Department": {
            "values": ["Men", "Women", "Unisex Adults", "Boys", "Girls"],
            "strict": True,
        },
        "Size Type": {
            "values": ["Regular", "Big & Tall"],
            "strict": True,
        },
        "Size": {
        ...
        "Color": {
            "values": ["Beige", "Black", "Blue", "Brown", "Clear", "Gold", "Gray", "Green", "Ivory", "Multicolor", "Orange", "Pink", "Purple", "Red", "Silver", "White", "Yellow"],
            "strict": True,
            "normalize": {"Olive": "Green", "Khaki": "Green", "Navy": "Blue", "Cream": "Ivory", "Tan": "Beige", "Charcoal": "Gray"},
        },
        "Theme": {
        ...
        "Occasion": {
            "values": ["Business", "Casual", "Formal", "Party/Cocktail", "Travel", "Workwear"],
            "strict": True,
        },
        "Features": {
            "values": [
        ...
        "Accents": {
            "values": ["Button", "Embroidered", "Fur Trim", "Glitter", "Logo", "Quilted", "Zipper"],
            "strict": True,
            "multi": True,
        },
        "Country/Region of Manufacture": {
            ...
            "strict": True,
            "normalize": {"USA": "United States", "UK": "United Kingdom", "South Korea": "South Korea (Republic of Korea)", "Korea": "South Korea (Republic of Korea)"},
        },
        "Jacket/Coat Length": {
            "values": ["Short", "Mid-Length", "Long"],
            "strict": True,
        },
        "Garment Care": {
            "values": ["Dry Clean Only", "Hand Wash Only", "Machine Washable"],
            "strict": True,
        },
        "Vintage": {"values": ["Yes", "No"], "strict": True},
        "Handmade": {"values": ["Yes", "No"], "strict": True},
