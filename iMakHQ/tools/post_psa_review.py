...
#   ★「仕入元が売り切れ」も入れる (2026-09-16 ユーザー確定「入れといて。タイムラグあるし。
#     永久に出さないで」)。監視くんが気づくまでの**タイムラグ**があり、目視の時に人が見つけた
#     売り切れの方が確か。日数 0 = 永久に出さない。
PASS_REASONS = (
    ("bundle", "仕入元が複数枚・まとめ売り (1枚だけ買えない)", 0),
    ("seller", "出品者が不安 (評価・取引条件)", 0),
    ("gone", "仕入元が売り切れ・買えない", 0),
    # ★2026-09-25 ユーザー「新規の目視で、見送り理由に海外版を入れておいて」。現物そのものが海外版なので変わらない = 永久
    ("foreign", "海外版 (英語版など・日本語版ではない)", 0),
