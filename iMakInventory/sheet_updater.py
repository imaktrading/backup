...
# ★ 2026-09-07 ユーザー判断: 死んだ補URLは **上限なく** 掃除する。
#   理由: 消したURLは復元アーカイブに残り、補充も毎晩回るので、数本 間違えて消しても
#   取り返せる。逆に掃除が遅れると 予備枠 (5本) が死骸で埋まり、**新しい補充が入らない**
#   (2026-09-07 実測: 死んだ予備を抱える 65 行のうち 15 行が 5/5 埋まりで補充不能、
#   13 行は予備が全部死んでいた)。旧設定 (20件/cycle) では入ってくる量に追いつかず、
#   積み残しが 26 → 101 件と増え続けていた。
