...
# iMakeBayAPI を sys.path に追加 (iMakInventory graduation 後のパス)
_IMAK_EBAY_API = SCRIPT_DIR.parent / "iMakeBayAPI"
if _IMAK_EBAY_API.is_dir() and str(_IMAK_EBAY_API) not in sys.path:
