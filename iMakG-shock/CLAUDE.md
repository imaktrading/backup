...
ShippingProfileName は **`DDP-{group}-P{tier}`** 形式。実例: DDP-A-P19 等 (G-SHOCK は group A)。
...
タイトル生成時、`C:\dev\iMak\iMakKeywords\Jewelry_Watches_2026Q1.pdf` の上位キーワードを最優先で盛り込む。検索されないタイトルは意味がない。
