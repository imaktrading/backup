...
def test_cp4_075_m_lucario_ex_added():
    ...
    # 2026-08-11 §3 は「読める形を維持」で 'Premium Champion Pack' を carve-out していたが、
    # **2026-08-21 に窓口が code 形を正と確定**したため上書き
    # (hq/requests/2026-08-21_set_name_and_name_en_need_ebay_facet_response.md §2)。
    assert r.get("set_name_ebay") == "CP4: Premium Champion Pack"
