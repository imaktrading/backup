...
D = {
    ...
    "Features":           ("specs.features_ebay", True, "catalog", "Holo/Reverse Holo は Features に無い (Finish の値)", "2026-08-22"),
    ...
    "Year Manufactured":  ("specs.release_year", True, "catalog", "変換表に year の無い弾は空欄 (推測しない)", "2026-08-22"),
    ...
    "Customized":         (None, False, "catalog", "扱いが無い", "2026-08-22"),
    "Material":           (None, False, "catalog", "扱いが無い", "2026-08-22"),
    "Vintage":            (None, False, "catalog", "定義が曖昧。出さない", "2026-08-22"),
    "Convention/Event":   (None, False, "catalog", "扱いが無い", "2026-08-22"),
    "Franchise":          (None, False, "catalog", "Game で足りる", "2026-08-22"),
    "Country of Origin":  ("fixed:Japan", False, "listing", "PSA10 運用の固定値。出品側が持つ", "2026-08-22"),
    "California Prop 65 Warning": (None, False, "listing", "出品側の運用", "2026-08-22"),
    "Cost":               (None, False, "catalog", "eBay に値リストが無く、カード種別で意味が違う", "2026-08-22"),
    # --- 出品側が持つもの (カタログは関与しない) ---
