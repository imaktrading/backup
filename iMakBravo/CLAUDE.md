...
2. `daily_report.md` の最上段に **`## YYYY-MM-DD HH:MM [BRAVO] 着手: <件名>`** を書いてから始める
...
見出しに書き手を明記: `## YYYY-MM-DD HH:MM [BRAVO] 〜`
